...
<link href="http://www.test.com/admin.shop.com/Public/Admin/css/general.css" rel="stylesheet" type="text/css" />
<link href="http://www.test.com/admin.shop.com/Public/Admin/css/main.css" rel="stylesheet" type="text/css" />
<link href="http://www.test.com/admin.shop.com/Public/Admin/css/common.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="http://www.test.com/admin.shop.com/Public/Admin/js/jquery-1.11.3.js"></script>
<script type="text/javascript" src="http://www.test.com/admin.shop.com/Public/Admin/layer/layer.js"></script>
<script type="text/javascript" src="http://www.test.com/admin.shop.com/Public/Admin/js/common.js"></script>
<script type="text/javascript">
    ...
    <script type="text/javascript" src="http://www.test.com/admin.shop.com/Public/Admin/uploadify/jquery.uploadify.min.js"></script>
    <script type="text/javascript">
        $(function(){
            $('#logo_uploader').uploadify({
                ...
                'swf'           : 'http://www.test.com/admin.shop.com/Public/Admin/uploadify/uploadify.swf',  //flash插件地址
